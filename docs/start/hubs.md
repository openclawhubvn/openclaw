...
<Note>
Nếu bạn mới làm quen với OpenClaw, hãy bắt đầu với [Hướng Dẫn Bắt Đầu](/start/getting-started).
</Note>

Sử dụng các hub này để khám phá mọi trang, bao gồm cả các tài liệu chuyên sâu và tham khảo không xuất hiện trong thanh điều hướng bên trái.

## Bắt đầu từ đây

- [Chỉ mục](/)
- [Hướng Dẫn Bắt Đầu](/start/getting-started)
...
- [Nix](/install/nix)
- [Cập Nhật / Quay Lại](/install/updating)
- [Quy Trình Bun (thử nghiệm)](/install/bun)
...
- [Thời Gian Chạy của Agent](/concepts/agent)
- [Không Gian Làm Việc của Agent](/concepts/agent-workspace)
- [Bộ Nhớ](/concepts/memory)
- [Vòng Lặp Agent](/concepts/agent-loop)
- [Truyền Tải + Chia Nhỏ](/concepts/streaming)
- [Định Tuyến Đa Agent](/concepts/multi-agent)
- [Nén](/concepts/compaction)
- [Phiên](/concepts/session)
- [Tỉa Phiên](/concepts/session-pruning)
...
- [Chuyển Đổi Mô Hình](/concepts/model-failover)
- [OAuth](/concepts/oauth)

## Nhà cung cấp + ingress

- [Trung Tâm Kênh Chat](/channels)
...
- [Ghép Đôi Gateway](/gateway/pairing)
...
- [Công Cụ PDF](/tools/pdf)
- [Chế Độ Nâng Cao](/tools/elevated)
- [Công Việc Cron](/automation/cron-jobs)
- [Cron vs Nhịp Tim](/automation/cron-vs-heartbeat)
- [Suy Nghĩ + Chi Tiết](/tools/thinking)
- [Mô Hình](/concepts/models)
- [Sub-agents](/tools/subagents)
- [Gửi Agent CLI](/tools/agent-send)
- [Giao Diện Người Dùng Terminal](/web/tui)
- [Điều Khiển Trình Duyệt](/tools/browser)
- [Trình Duyệt (Khắc Phục Sự Cố Linux)](/tools/browser-linux-troubleshooting)
- [Khảo Sát](/automation/poll)
...
- [Đánh Thức Bằng Giọng Nói](/nodes/voicewake)
- [Chế Độ Nói Chuyện](/nodes/talk)

## Nền tảng

- [Tổng Quan Nền Tảng](/platforms)
...
- [Truy Cập Từ Xa macOS](/platforms/mac/remote)
- [Ký Tên macOS](/platforms/mac/signing)
- [Gateway macOS (launchd)](/platforms/mac/bundled-gateway)
- [XPC macOS](/platforms/mac/xpc)
- [Kỹ Năng macOS](/platforms/mac/skills)
- [Peekaboo macOS](/platforms/mac/peekaboo)

## Mở rộng + plugin

- [Tổng Quan Plugin](/tools/plugin)
- [Xây Dựng Plugin](/plugins/building-plugins)
- [Manifest Plugin](/plugins/manifest)
- [Công Cụ Agent](/plugins/building-plugins#registering-agent-tools)
- [Gói Plugin](/plugins/bundles)
- [Plugin Cộng Đồng](/plugins/community)
- [Sách Nấu Khả Năng](/tools/capability-cookbook)
- [Plugin Cuộc Gọi Bằng Giọng Nói](/plugins/voice-call)
- [Plugin Người Dùng Zalo](/plugins/zalouser)
...
- [Chính Sách Phát Hành](/reference/RELEASING)
